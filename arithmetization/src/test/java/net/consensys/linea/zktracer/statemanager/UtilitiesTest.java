...
public class UtilitiesTest {
  ...
  void testBuildingBlockOperations() {
    ...
    MultiBlockExecutionEnvironment.builder()
            ...
            .addBlock(List.of(tc.writeToStorage(tc.externallyOwnedAccounts[0], tc.keyPairs[0], tc.addresses[0], 123L, 1L, false, BigInteger.ZERO)))
            .addBlock(List.of(tc.readFromStorage(tc.externallyOwnedAccounts[0], tc.keyPairs[0], tc.addresses[0], 123L, false, BigInteger.ZERO)))
...
// initialize the test context
    ...
    MultiBlockExecutionEnvironment.builder()
            .accounts(List.of(tc.initialAccounts[0], tc.externallyOwnedAccounts[0], tc.frameworkEntryPointAccount))
            .addBlock(List.of(
                    tc.deployWithCreate2(tc.externallyOwnedAccounts[0],
                            tc.keyPairs[0],
